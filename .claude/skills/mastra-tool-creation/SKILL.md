...
description: Guide for creating new Mastra tools in the Hey Jarvis MCP project. Use this when asked to create new tools or API integrations.
---
...
- Integration with Mastra's tool ecosystem
