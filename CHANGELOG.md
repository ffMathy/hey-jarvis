...
* **hologram:** greet on summon, arrive as a vortex, listen with a lattice ([#762](https://github.com/ffMathy/hey-jarvis/issues/762)) ([a06552f](https://github.com/ffMathy/hey-jarvis/commit/a06552fbb247f487eae366568d279098740e25e6))
...
## [2.4.0](https://github.com/ffMathy/hey-jarvis/compare/root-v2.3.0...root-v2.4.0) (2026-09-19)
...
## [2.0.0](https://github.com/ffMathy/hey-jarvis/compare/root-v1.14.1...root-v2.0.0) (2026-09-16)
...
## [1.12.5](https://github.com/ffMathy/hey-jarvis/compare/root-v1.12.4...root-v1.12.5) (2026-08-21)
...
## [1.12.1](https://github.com/ffMathy/hey-jarvis/compare/root-v1.12.0...root-v1.12.1) (2026-08-20)
...
## [1.10.0](https://github.com/ffMathy/hey-jarvis/compare/root-v1.9.1...root-v1.10.0) (2026-08-18)
...
* **hooks:** enforce command timeouts and fix block-op-env failing open ([61ed5c7](https://github.com/ffMathy/hey-jarvis/commit/61ed5c7c59d59459804e46aa586a3b8282572166))
...
* **scripts:** read Bilkatogo from the Shared vault ([80a0501](https://github.com/ffMathy/hey-jarvis/commit/80a05017ae3df9021e86228ff685f738e69c0f38))
...
* actions log ([7b6d13b](https://github.com/ffMathy/hey-jarvis/commit/7b6d13b948fc951df4f9b7fc418f887f19189076))
* actions log ([#648](https://github.com/ffMathy/hey-jarvis/issues/648)) ([50f594b](https://github.com/ffMathy/hey-jarvis/commit/50f594b0235bee544c0cf83e5bc684db7e5bc114))
* **deps:** clear every critical and most high advisories ([191012d](https://github.com/ffMathy/hey-jarvis/commit/191012da35cdb1a4b14c6b47de0cff3de68e6654))
...
* **mcp:** pin typescript to 6.x so mastra dev can start ([d560a1f](https://github.com/ffMathy/hey-jarvis/commit/d560a1f484f06e81b44a53e2a84140cc69a21c75))
...
* **scripts:** allow overriding the source vault in the migration ([1cbe60f](https://github.com/ffMathy/hey-jarvis/commit/1cbe60ff2c9f62ee618cd625fd6fa16a6ec27952))
* **scripts:** do not report dry-run previews as completed writes ([6dcf098](https://github.com/ffMathy/hey-jarvis/commit/6dcf098a592715d9a9b05c32d6f29f2285f7b7fe))
* **scripts:** explain moves blocked by the ssoLogin field type ([d36ab7f](https://github.com/ffMathy/hey-jarvis/commit/d36ab7f1f9bd0cebb6363b5196750d6e42d1e794))
* **scripts:** install Node.js in the WSL bootstrap ([a3ed8eb](https://github.com/ffMathy/hey-jarvis/commit/a3ed8ebfec8d153b768d1a42e7e77a44b6187b8a))
...
* **scripts:** keep vault overrides in the post-rehearsal command hint ([c239e64](https://github.com/ffMathy/hey-jarvis/commit/c239e64fc1d9f6f1f59ca369ec2b75f8c9f8fa7f))
* **scripts:** restore executable bit on setup-wsl.sh ([f8b90c2](https://github.com/ffMathy/hey-jarvis/commit/f8b90c2c1145db4ecccb5af0bb76c6b0179d9e5f))
* **scripts:** stop passing secrets to 1Password via argv ([2553fa8](https://github.com/ffMathy/hey-jarvis/commit/2553fa82e9d468a9fa60ebf0b9359177cd6adeb3))
* **scripts:** surface why an item move failed ([b759b99](https://github.com/ffMathy/hey-jarvis/commit/b759b998ed742889419ea43cf97be7ee22b94a36))
...
## [1.9.1](https://github.com/ffMathy/hey-jarvis/compare/root-v1.9.0...root-v1.9.1) (2026-03-19)
...
## [1.8.0](https://github.com/ffMathy/hey-jarvis/compare/root-v1.7.0...root-v1.8.0) (2026-02-25)


### Features

* add dependency cooldown policy to Dependabot ([7cedf69](https://github.com/ffMathy/hey-jarvis/commit/7cedf690aaa7bd913a99e5044a42610c4d3eb5c0))
* add dependency cooldown policy to Dependabot ([#513](https://github.com/ffMathy/hey-jarvis/issues/513)) ([69f737e](https://github.com/ffMathy/hey-jarvis/commit/69f737edb11fcd464fee6064b1b7f328745502a7))
...
* add claude hooks for various things ([115755f](https://github.com/ffMathy/hey-jarvis/commit/115755f4d0b24ffc2007a120c486b3d2800923d3))
* add claude hooks for various things ([#528](https://github.com/ffMathy/hey-jarvis/issues/528)) ([534c141](https://github.com/ffMathy/hey-jarvis/commit/534c1416c932dfc144e5ea0f31b44c73484a5b9e))
* add trusted dependencies to avoid supply chain attacks ([08059e3](https://github.com/ffMathy/hey-jarvis/commit/08059e3031847cdb1657808e341761b2b71a898b))
* add trusted dependencies to avoid supply chain attacks ([#511](https://github.com/ffMathy/hey-jarvis/issues/511)) ([73e78df](https://github.com/ffMathy/hey-jarvis/commit/73e78df9083d0d27db5c8a875400b08097ca1b04))
...
* include playwright as trusted dependency ([563979f](https://github.com/ffMathy/hey-jarvis/commit/563979f140761a4b6e06c3f61f101de4f257b130))
...
## [1.7.0](https://github.com/ffMathy/hey-jarvis/compare/root-v1.6.0...root-v1.7.0) (2026-02-21)
...
* better settings for confidentiality ([3a496ea](https://github.com/ffMathy/hey-jarvis/commit/3a496ea7ea5cda9e5411a879fd926fa37723275e))
* better test capabilities ([4a2d9a2](https://github.com/ffMathy/hey-jarvis/commit/4a2d9a2ed911f54d9259f97e20c576e13592dd53))
* input schema ([191d8b5](https://github.com/ffMathy/hey-jarvis/commit/191d8b550ce84a2041e41ecf64205c9e56796b2a))
* invalid embedding model ([a6a1a79](https://github.com/ffMathy/hey-jarvis/commit/a6a1a79f007fc775677b13a8a3ca71e4c92ad72f))
...
* much better testing and ollama integration ([4b3cbcc](https://github.com/ffMathy/hey-jarvis/commit/4b3cbcc94cb8afcbbed0270fde8bbf9933b59b5c))
* only ignore .turbo subdirectories, not the entire .turbo/ directory ([543fbfa](https://github.com/ffMathy/hey-jarvis/commit/543fbfafb88a4250ba801014e321dd03f46711b2))
* split targets to help debug memory leak ([110389e](https://github.com/ffMathy/hey-jarvis/commit/110389e1685fd6d5db007613e05099e76dfdc796))
* split targets to help debug memory leak ([#507](https://github.com/ffMathy/hey-jarvis/issues/507)) ([6931ac9](https://github.com/ffMathy/hey-jarvis/commit/6931ac98bcceaa5a06437455373688a50b140c2c))
* use gpt-4o for routing agent in CI and cache TURBO build outputs ([675529b](https://github.com/ffMathy/hey-jarvis/commit/675529b2b81df52409ccbde2018ce43868b8646f))
* use gpt-4o for routing agent in CI and cache TURBO build outputs ([#506](https://github.com/ffMathy/hey-jarvis/issues/506)) ([f7fbde2](https://github.com/ffMathy/hey-jarvis/commit/f7fbde214fe7f757f60eb90b91f72c9852b4420d))

## [1.6.0](https://github.com/ffMathy/hey-jarvis/compare/root-v1.5.1...root-v1.6.0) (2026-02-20)
...
* convert testing skill to Claude rule, update type safety skill ([6bd71c0](https://github.com/ffMathy/hey-jarvis/commit/6bd71c0a4a66e8102c9d571ed9ee0fabc88f107f))
...
* add claude code ([2785dec](https://github.com/ffMathy/hey-jarvis/commit/2785decee2f2ca1cdda25e4a71eb4fda11afe6b1))
...
* convert to claude skills ([c1265b2](https://github.com/ffMathy/hey-jarvis/commit/c1265b2ebb32c075dc6eb800890eea4777ce18bc))
...
* mcp improvements ([a31840c](https://github.com/ffMathy/hey-jarvis/commit/a31840c69ef23dce2b7dd1d3397e55a46e873970))
...
* skills settings ([06d5be8](https://github.com/ffMathy/hey-jarvis/commit/06d5be870fc2d9c9f4f81f6dfa89be1ce7937a98))
...
* reduced turbo parallelism to improve stability ([774e42f](https://github.com/ffMathy/hey-jarvis/commit/774e42ff6cc3e1e5b13058787b1a28418ea355a2))
...
* TURBO support for DevX ([03fbc56](https://github.com/ffMathy/hey-jarvis/commit/03fbc56575fc5ddc3b8b41cefcc15feb5ab1fb39))
...
* **ci:** configure git safe.directory in devcontainer for TURBO affected detection ([#194](https://github.com/ffMathy/hey-jarvis/issues/194)) ([30fcec7](https://github.com/ffMathy/hey-jarvis/commit/30fcec72c25199403cce27f40ba19511a49f6c02))
...
* tests now truly run via turbo too ([cbe44fd](https://github.com/ffMathy/hey-jarvis/commit/cbe44fdbea93edb03f509b7261904db99cae62be))
...
* tests now truly run via turbo too ([85d3ac5](https://github.com/ffMathy/hey-jarvis/commit/85d3ac52e76e04162d325c6f5bdc297ae14a8fac))
