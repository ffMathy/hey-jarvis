...
const mealPlanFeedbackIterationWorkflow = createWorkflow({
  ...
  // @ts-expect-error - Mastra v1 beta.9 workflow chaining has state schema compatibility issues that prevent proper type inference
...
export const weeklyMealPlanningWorkflow = createWorkflow({
  ...
  // @ts-expect-error - Mastra v1 beta.9 dowhile has state schema compatibility issues that prevent proper type inference
