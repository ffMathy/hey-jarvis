...
- Additional details like phone numbers, websites, and opening hours when requested`,
    description: `# Purpose
Assist with commute planning, route navigation, and finding places using Google Maps data. Provide travel time estimates with traffic, search for locations along routes or nearby, and retrieve detailed place information.
