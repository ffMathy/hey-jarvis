 ...
 *
 * Written down so that the next summoning does not have to find out again. The loop that measures
 * it starts sparse and climbs — see `density-control.ts` — which takes a couple of seconds, and
 * those are the two seconds somebody is actually looking at him. Starting from what he managed
 * yesterday skips them.
 *
